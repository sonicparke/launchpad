...
//     });
//   }]);
app.controller('AppListViewCtrl', ['$scope', '$location', '$http', '$timeout', 'GetMenuItems', function ($scope, $location, $http,  $timeout, GetMenuItems){
...
app.controller('LoginViewCtrl', ['$scope', '$location', '$q', '$http', '$timeout', function ($scope, $location, $q, $http,  $timeout){
...
app.controller('MainCtrl', ['$scope', '$location', '$http', '$timeout', 'GetMenuItems', function ($scope, $location, $http,  $timeout, GetMenuItems){
...
app.service('GetMenuItems', ['Restangular', 'ServerAPI', function(Restangular, ServerAPI) {
...
app.directive('ngServerSelect', function () {
    ...
    return{
        restrict: 'E,A',
        replace: true,
        controller: ['$scope', 'User', 'ServerAPI', function($scope, User, ServerAPI){
